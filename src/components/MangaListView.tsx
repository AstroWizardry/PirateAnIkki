...
const MangaListView: React.FC<MangaListViewProps> = ({
  mangas,
  onMangaClick,
  loading = false,
}) => {
    ...
    <div className="space-y-4">
      {mangas.map((manga) => (
        <div
          ...
          className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-all duration-200 cursor-pointer hover:border-gray-300 dark:hover:border-gray-600"
        >
          <div className="flex space-x-4">
            {/* Cover Image */}
            <div className="relative flex-shrink-0">
              ...
              <div className="absolute -top-1 -right-1">
                <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(manga.status)}`}>
